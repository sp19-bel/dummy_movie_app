...
class MovieDetailsService extends DioRequestProtocol {
  final int movieId;

  MovieDetailsService({required this.movieId});
  ...
  @override
  String get endpoint =>
      di<ApiClient>().endpoint(Api.movieDetails, movieId: movieId);

  @override
  String get method => di<ApiClient>().method(Api.movieDetails);
